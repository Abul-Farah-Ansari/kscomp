  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://kscompmail.onrender.com/api/contact",
        {
          ...
          body: JSON.stringify({
            ...
            subject: formData.service || "Website Enquiry",
      ...
      if (err.name === "AbortError") {
        ...
        setError(
          "Unable to connect to the enquiry server. Please try again."
        );
      } else {
        setError(
          err.message ||
          ...
          >
            ...
            {submitted ? (
              ...
              <>
                ...
                {error && (
                  <div className="mt-6 border border-red-300/30 bg-red-500/10 px-4 py-4 text-sm leading-6 text-red-200">
                    {error}
                  </div>
                )}
                ...
                >
                  ...
                  <div className="sm:col-span-2">
                    ...
                    >
                      ...
                      <option value="Other Compliance Services">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <button
                      type="submit"
                      disabled={sending}
                      className="flex w-full items-center justify-center gap-3 bg-white px-6 py-4 text-sm font-semibold text-[#102b29] transition duration-300 hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      ...
                      {sending ? (
                        <>
                          ...
                          <span className="h-4 w-4 animate-spin rounded-full border-2 border-[#102b29]/30 border-t-[#102b29]" />
                        </>
                      ) : (
                        <>
