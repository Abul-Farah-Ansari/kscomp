  ...
  const services = [
    {
      ...
      text: "Professional assistance for accurate preparation and timely filing of income tax returns.",
    },
    {
      title: "GST Services",
      text: "Support for GST registration, return filing and important compliance requirements.",
    },
    {
      title: "TDS & TCS",
      text: "Guidance and assistance for applicable TDS and TCS related responsibilities.",
    },
    {
      title: "PF & ESI",
      text: "Support for important employee-related statutory and compliance requirements.",
    },
  ];
      ...
      <div className="mx-auto max-w-[1280px] px-6 sm:px-10 lg:px-14">
        ...
        >
          ...
          <p className="mt-7 text-lg leading-8 text-[#102b29]/70">
            Professional support for important taxation and statutory
            compliance requirements with a focus on accuracy, documentation
            and timely action.
          </p>
        </motion.div>
