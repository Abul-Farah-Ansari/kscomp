...
/* =====================================================
   RANDOM BARS SETTINGS

   This creates the PowerPoint-style Random Bars effect.
===================================================== */
...
/*
  ...
  Each bar receives a different delay so they do not
  animate from left to right in sequence.
*/
  ...
  return (
    ...
    >
      {/* =====================================================
          ...
          POWERPOINT STYLE RANDOM BARS TRANSITION
      ====================================================== */}
      ...
      <AnimatePresence mode="sync">
        ...
        >
          {Array.from({ length: BAR_COUNT }).map((_, index) => {
            ...
            /*
              Alternating reveal direction.

              Some bars reveal from top,
              some reveal from bottom.
            */
