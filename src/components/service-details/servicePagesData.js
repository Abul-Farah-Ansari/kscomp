const servicePagesData = [
...

  {
    ...
    title: "Insurance & Protection Solutions",
...

  {
    ...
    title: "Accounting & Financial Solutions",
...

  {
    ...
    title: "HR & Payroll Compliance Solutions",
...

  {
    ...
    services: [
      ...
      {
        number: "03",
        name: "Project Report for Loan / CC / OD",
        description:
          "Preparation of detailed project reports and financial documents required for Loan, CC & OD applications, with proper business and financial projections.",
      },
  ...
  /* =========================================================
     07 - DOCUMENTATION SUPPORT SERVICES
  ========================================================= */

  {
    ...
    services: [
...

      {
        ...
        description:
          "Drafting and registration of Partnership Deeds, covering partners’ rights, responsibilities, profit sharing, and business terms.",
      },

      {
        ...
        name: "LLP Deed",
        description:
          "Drafting and registration of LLP Deeds, covering partners’ rights, responsibilities, profit sharing, and business terms.",
      },

      {
        ...
        name: "NOC",
        description:
          "Assistance in obtaining No Objection Certificates (NOC) for bank, government, landlord, and other official purposes.",
      },
    ],
  },
